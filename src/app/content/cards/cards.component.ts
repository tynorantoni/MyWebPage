...
import {CardImplementation} from "../content.module";
...
export class CardsComponent implements OnInit {
  ...
  aboutNow: string = 'Aktualnie pracuję w dziale Preparatyki Regionalnego Centrum Krwiodawstwa i Krwiolecznictwa w Krakowie. ' +
    ...
    'jako audytor - kontrola innych oddziałów. Umiejętności szybkiego przyswajania wiedzy, logicznego myślenia oraz dokładnosć przydały mi się zarówno na początku ' +
    'mojej drogi zawodowej jak i podczas nauki Javy.  ';
  ...
  aboutFuture: string = 'Chęć rozwoju, oraz poszukiwanie nowych wyzwań doprowadziły mnie do zainteresowania się tematem programowania. ' +
    ...
    'między innymi takie technologie jak: Java, Spring, MySQL, Angular 2. Poznałem również metodologię pracy Agile, sam staram się stosować Scrum w swojej nauce, oraz projektach. ' +
  ...
  @Output('kart') cards: Array<CardImplementation> = [
    new CardImplementation('Dzień Dobry!', this.about, '/assets/img/def.jpeg'),
    new CardImplementation('Przeszłość', this.aboutPast, '/assets/img/past.jpeg'),
    new CardImplementation('Teraźniejszość', this.aboutNow, '/assets/img/now.jpg'),
    new CardImplementation('Przyszłość', this.aboutFuture, '/assets/img/future.jpg'),
  ];
